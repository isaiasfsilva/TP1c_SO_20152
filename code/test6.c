...
int main(void) {
	...
	strcat(page0, "Oi");//Escreve "oie" em 0x60000000

	page1[0] = '\0';//aloca na posicao 0x60001000
	strcat(page1,"UMM");//Escreve "UMMMM" em 0x60001000

	page2[0] = '\0';//aloca na posicao 0x60002000
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	...
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	...
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!");
	strcat(page2,"defoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooois!psssssssssssssssssssssssssssssss");
	...
	uvm_syslog(page2+2, strlen(page2));
        //Deveria imprimir:
	//     oieZERO
	//	UMMMM
